  ...
  <div class=" p-4 m-4 rounded bg-gray-200">
    <div class="flex">
      ...
      <div class="p-4">
        ...
        <span class="text-lg"><b>LinkedIn:</b> <a class="underline text-blue-500" href="https://www.linkedin.com/in/jesus-gomez-bra%C3%B1a-gonzalez-793765198/">click aqui</a></span>
