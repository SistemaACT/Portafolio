<script lang="ts">
    ...
    $: {
      ...
      for(let i =0;i<ponderaciones.length;i++){
        suma_ponderaciones+=Number(ponderaciones[i])
      }
...
<div class="w-full bg-blue-500 text-white p-5 text-2xl font-bold flex items-center  space-x-4 ">
    <h1>
        Proyecto Final Tópicos Financieros
    </h1>
...
<div class="bg-gray-200 rounded p-4 flex flex-col items-center m-4 shadow-md">
    ...
    <p class="text-justify p-2">
      Esto se realizó para facilitar la visualización de la información relevante al proyecto final.
      Puesto que al utilizar Google Sheets se podría ver limitado por la funcionalidad que tiene este.
      De esta manera se lograra explorar más a fondo lo realizado en clase y brindara ideas nuevas al modelo
      propuesto en clase
    </p>
    <h3 class="w-full bg-white rounded text-xl font-bold text-center">Sobre el modelo</h3>
    <p class="text-justify p-2">
      Para este modelo se está realizando un cripto portafolio, en el cual se analizaran datos reales para
      determinar si el portafolio sería rentable al igual que medir sus riesgos. Una de la manera en la cual sé 
      se realiza esto es mediante la implementación del modelo value at risk. El cual resulta te da una idea de cuanto podría salir mal un proyecto de inversión.
    </p>
    <p class="text-justify p-2">
      Esta página no persiste información, por lo cual si en algún punto del proceso agrega información y desea borrarla tendrá que reiniciar la página.
      Esto ocasionará que toda la información sea borrada y tendrá que volver a empezar el programa. A continuación dejo las instrucciones de uso:
    </p>
...
<div class="m-4 p-4 bg-gray-200 rounded">
  ...
  <p>Para ver el analysis de los estimadores y de la varianza covarianza y VaR tiene que comprar al menos una moneda</p>
  ...
  <div class="bg-gray-200 m-4 rounded p-4">
    ...
    <div class="flex justify-evenly bg-white p-2 rounded">
      ...
      <div class="flex flex-col p-2">
        ...
        <p>Dias desde compra:{hangle_date_diference(coin.fecha_de_compra)}</p>
...
<div>
  ...
  <div class=" p-4 m-4 rounded bg-gray-200">
          ...
          <ul class="flex justify-evenly">
            <li class="bg-white p-2 rounded shadow-md w-60 space-y-2 text-center">
              ...
              <ul class="flex flex-col space-y-4">
                ...
                <li class="bg-blue-500 text-white p-2 rounded">Typescript (Experto)</li>
            ...
            <li class="bg-white p-2 rounded shadow-md w-60">
              ...
              <ul class="flex flex-col space-y-4">
                ...
                <li class="bg-blue-500 text-white p-2 rounded">Nest.js (Intermedio)</li>
            ...
            <li class="bg-white p-2 rounded shadow-md w-60">
              ...
              <ul class="flex flex-col space-y-4">
                ...
                <li class="bg-blue-500 text-white p-2 rounded">Desarollo Desktop (Intermedio)</li>
    ...
    <div class="p-4 shadow-xl rounded border-t border-black space-y-4  my-4">
      ...
      <div class="bg-white rounded p-4 shadow-md">
        <h2 class="font-bold text-lg">Arrendadora y Construcciones del Trópico SA de CV</h2>
        <div class="flex justify-evenly">
          <div class="border border-black shadow-md rounded p-2">
            <p><b>Fecha:</b> 2012-presente</p>
            <b>Puestos:</b>
            <p>Supervisor de Obra</p>
            <p>Manejo de Redes Sociales</p>
            <p>Manejo de Sistemas</p>
   
          </div>
          <ul class="border border-black shadow-md rounded p-2">
            <b>Supervisor de Obra:</b>
            <li>Reportaje de progreso de obra</li>
            <li>Suministracion de materiales y herramienta</li>
            <li>Direccion de personal y maquinaria</li>
            <b>Manejo de Redes Sociales:</b>
            <li>Mantenimiento de pagina de Facebook y whatsapp empresarial</li>
            <li>Coordinacion de ventas con los ingenieros en planta</li>
            <li>Solicitud y entrega de facturas</li>
          </ul>
          <ul class="border border-black shadow-md rounded p-2">

            <b>Manejo de Sistemas:</b>
            <li>Elaboración de sistema de asistencia</li>
            <li>Elaboracion de sistema de inventario</li>
            <li>Elaboracion de sistema de suministro de comubstible</li>
            <li>Elaboracion de sistema antirobo de comubstible</li>
            <li>Elaboracion de sistema de manejo de ganado (Rancho: Nacimientos, Muertes, Parentesco, Tablas de mortalidad, Analysis estadistico)</li>
            <li>Mantenimiento a los sistemas anteriores</li>
          </ul>
      ...
      <div class="bg-white rounded p-4 shadow-md">
        <h2 class="font-bold text-lg">Comunidad Ashkenazi de México A.C.</h2>
        <div class="flex justify-evenly">
          <div class="border border-black shadow-md rounded p-2">
            <p><b>Fecha:</b> 2023-presente</p>
            <b>Puestos:</b>
            <p>Desarollo de Desktop</p>
            <p>Desarollo Web Full-Stack</p>
   
          </div>
          <ul class="border border-black shadow-md rounded p-2">
            <b>Desarollo de Desktop:</b>
            <li>Elaboracion de Interfaz Grafica con Tkinter</li>
            <li>Manejo de base de datos SQLite</li>
            <li>Compilacion con pyinstaller y Inno Setup</li>
            <li>Automatizacion de processos contables y fiscales</li>
            <li>Elaboracion de documentacion</li>

          </ul>
          <ul class="border border-black shadow-md rounded p-2">
            <b>Desarollo Web:</b>
            <li>Elaboracion del diseño se la interfaz</li>
            <li>Elaboracion de interfaz grafica de la aplicacion en Angular</li>
            <li>implementacion con plaid</li>
            <li>Implementacion de autentificacion con Firebase</li>
            <li>Manejo de base de datos en Firestore</li>
            <li>Elaboracion de backend en Nest.js</li>
          </ul>
  ...
  <iframe src="https://docs.google.com/document/d/e/2PACX-1vTpi2IeCd1cIJudJLlxDEuax5Hp9-PliOly02V7cwpnroObPq4NJx22Q4ckgY1kmIi3Sy4r1EhcYJcK/pub?embedded=true"></iframe>
