          ...
          <div class="p-4">
            ...
            <div class=" flex justify-between p-4">
              ...
              <button class="bg-green-500 text-white p-2 rounded"
                on:click={()=>{
                  console.log("here")
                  portafolio.push({id:coin.id,name:coin.name,precio_compra:purchase_price[i],precio_actual:coin_data[i].market_data.current_price.usd,cantidad_de_compra:purchase_ammount[i],fecha_de_compra:new Date(purchase_date[i])})
                }}
  ...
  <div class="bg-gray-200 rounded p-4">
    {#each portafolio as coin}
      <div>
        ...
        fecha de compra:{coin.fecha_de_compra.toISOString().split("T")[0]}
      </div>
