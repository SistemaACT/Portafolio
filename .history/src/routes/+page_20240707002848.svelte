...
<div class="bg-gray-200 rounded p-4 flex flex-col items-center m-4">
    <h2 class="w-full bg-gray-100 text-xl font-bold text-center">Acerca del modelo y del proyecto</h2>
    <p>
