        ...
        <div>
          ...
          <form class="p-4">
            <div class="flex flex-col">
              ...
              <input bind:value={purchase_ammount} class="bg-white border border-black rounded" placeholder="Cantidad a comprar" type="number" id="Cantidad"/>
            </div>
            <div class="flex flex-col">
            ...
            <div class=" flex justify-between p-4">
              ...
              <div>
                <p>Monto de compra</p>
                <p>${purchase_price[i]*purchase_ammount}</p>
              </div>
              <button class="bg-green-500 text-white p-2 rounded">Agregar al protafolio</button>
            </div>
          </form>
        </div>
      {/if}
