...
{#if coins}
<form class="w-full m-4 p-4 bg-gray-200 rounded flex justify-start space-x-5 items-center" >
...
<div class="m-4 p-4 bg-gray-200 rounded">
  <h2 class="w-full text-center text-2xl font-bold">Tu portafolio</h2>
  {#if selected_coins.length==0}
    <p>Aun no has seleccionado ninguna moneda para crear tu portafolio</p>
  {:else}
