...
<div>
  ...
  <div class=" p-4 m-4 rounded bg-gray-200">
    <div class="flex">
      <img class="w-2/5 p-4 rounded" src="/fotoPerfil.jpg" alt="Foto de perfil"/>
      <div class="p-4">
        ...
        <div>
          <h2 class="w-full text-center">Habilidades</h2>
          <ul class="flex justify-evenly bg-white space-x-2">
            <li>
