...
<div>
  <div class="w-full bg-blue-500 text-white text-2xl font-bold">Mi CV</div>
  <div class="flex p-4 m-4 rounded bg-gray-200">
    <img class="w-1/4 p-4 rounded" src="/fotoPerfil.jpg" alt="Foto de perfil"/>
    <div class="p-4">
      <p class="text-lg">Nombre: Jesús Gómez-Braña González</p>
      <p>Carrera: Ciencias Actuariales</p>
      <p>Minor: inteligencia Artificial</p>
      <span>LinkedIn: <a href="https://www.linkedin.com/in/jesus-gomez-bra%C3%B1a-gonzalez-793765198/">click aqui</a></span>
      <p>Objetivo:</p>
      <p>
    ...
    <ul>
      <li>
        **Lenguajes de Programación:**
        <ul>
          <li>JavaScript (Experto - Top 5% en LinkedIn)</li>
          <li>HTML (Experto - Top 10% en Fiverr)</li>
          <li>Python (Avanzado)</li>
          <li>Java (Intermedio)</li>
          <li>R (Intermedio)</li>
          <li>Visual Basic (Intermedio)</li>
          <li>GO lang (Básico)</li>
          <li>C (Básico)</li>
        </ul>
      </li>
      <li>
        **Idiomas:**
        <ul>
          ...
          <li>Inglés (Casi Nativo)</li>
          <li>Francés (Básico/Conversacional)</li>
        </ul>
      </li>
      <li>
        **Software:**
        <ul>
          <li>Google Sheets (Experto)</li>
          <li>Excel (Experto)</li>
        </ul>
      </li>
      <li>
  ...
  <div>
    ...
    <div>
      <h2>IMEF Universitario</h2>
      <p>Fecha: Diciembre 2020-Enero 2022</p>
      <p>Puestos:</p>
